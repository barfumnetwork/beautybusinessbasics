...
export const questions: Question[] = [
  ...
  // Prospecting
  { id: 31, text: 'Was ist Prospecting?', category: 'Prospecting', source: 'Fanatical Prospecting — Jeb Blount', lesson: 'L11' },
  { id: 32, text: 'Wo finde ich überhaupt Menschen?', category: 'Prospecting', source: 'Fanatical Prospecting — Jeb Blount', lesson: 'L14' },
  { id: 33, text: 'Was, wenn ich niemanden kenne?', category: 'Prospecting', source: 'Blount, Law of Familiarity', lesson: 'L14',
    tags: ['kontakte', 'niemand', 'liste', 'allein'], },
  { id: 34, text: 'Muss ich meine Freunde anschreiben?', category: 'Prospecting', source: 'Academy', lesson: 'L11',
    tags: ['freunde', 'familie', 'bekannte', 'umfeld', 'nerven'], },
  { id: 35, text: 'Muss ich Fremde ansprechen?', category: 'Prospecting', source: 'Fanatical Prospecting — Jeb Blount', lesson: 'L14' },
  { id: 36, text: 'Wie viele Menschen muss ich ansprechen?', category: 'Prospecting', source: 'Fanatical Prospecting — Jeb Blount', lesson: 'L13',
    tags: ['anzahl', 'wie viele', 'menge', 'quote'], },
  { id: 37, text: 'Wie oft soll ich das machen?', category: 'Prospecting', source: 'Blount, 30-Tage-Regel', lesson: 'L13',
    tags: ['zeit', 'regelmäßig', 'häufigkeit', 'rhythmus'], },
  { id: 38, text: 'Warum passiert in der ersten Woche nichts?', category: 'Prospecting', source: 'Blount, 30-Tage-Regel', lesson: 'L12',
    tags: ['zeit', 'geduld', 'anfang', 'nichts passiert'], },
  { id: 39, text: 'Brauche ich Social Media?', category: 'Prospecting', source: 'Blount, 5 C’s of Social Selling', lesson: 'L15',
    tags: ['instagram', 'tiktok', 'social media', 'follower', 'reichweite', 'online'], },
  { id: 40, text: 'Was, wenn ich nur 100 Follower habe?', category: 'Prospecting', source: 'Academy', lesson: 'L15',
    tags: ['instagram', 'follower', 'reichweite', 'klein'], },
  { id: 41, text: 'Muss ich mein Gesicht zeigen?', category: 'Prospecting', source: 'Academy', lesson: 'L15',
    tags: ['instagram', 'video', 'reels', 'gesicht', 'kamera'], },
  { id: 42, text: 'Wie halte ich das durch, wenn es nicht läuft?', category: 'Prospecting', source: 'Blount und Maxwell, Gesetz 3', lesson: 'L13',
  ...
  // Follow-up
  { id: 60, text: 'Was ist Follow-up?', category: 'Follow-up', source: 'Go Pro — Eric Worre, Schritt 4', lesson: 'L27' },
  { id: 61, text: 'Wann melde ich mich wieder?', category: 'Follow-up', source: 'Academy', lesson: 'L27' },
  { id: 62, text: 'Nerve ich dann nicht?', category: 'Follow-up', source: 'Academy', lesson: 'L28',
    tags: ['nerven', 'aufdringlich', 'nachfassen'], },
  { id: 63, text: 'Wie oft darf ich nachfassen?', category: 'Follow-up', source: 'Academy', lesson: 'L29' },
  { id: 64, text: 'Wann höre ich auf?', category: 'Follow-up', source: 'Academy', lesson: 'L29' },
